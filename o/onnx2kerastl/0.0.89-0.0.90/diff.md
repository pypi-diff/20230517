# Comparing `tmp/onnx2kerastl-0.0.89.tar.gz` & `tmp/onnx2kerastl-0.0.90.tar.gz`
...
### Comparing `onnx2kerastl-0.0.89/onnx2kerastl/utils.py` & `onnx2kerastl-0.0.90/onnx2kerastl/utils.py`
