# Comparing `tmp/amuse-2023.4.0.tar.gz` & `tmp/amuse-2023.5.0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "amuse-2023.4.0.tar", last modified: Tue Apr  4 14:19:30 2023, max compression
+gzip compressed data, was "amuse-2023.5.0.tar", last modified: Wed May 17 10:17:25 2023, max compression
```

## Comparing `amuse-2023.4.0.tar` & `amuse-2023.5.0.tar`

### file list

```diff
@@ -1,23 +1,23 @@
-drwxr-xr-x   0 rieder     (501) staff       (20)        0 2023-04-04 14:19:30.092760 amuse-2023.4.0/
--rw-r--r--   0 rieder     (501) staff       (20)      140 2020-03-24 14:36:23.000000 amuse-2023.4.0/MANIFEST.in
--rw-r--r--   0 rieder     (501) staff       (20)     1194 2023-04-04 14:19:30.092438 amuse-2023.4.0/PKG-INFO
--rw-r--r--   0 rieder     (501) staff       (20)       83 2020-03-24 14:36:23.000000 amuse-2023.4.0/README.md
-drwxr-xr-x   0 rieder     (501) staff       (20)        0 2023-04-04 14:19:30.088768 amuse-2023.4.0/amuse.egg-info/
--rw-r--r--   0 rieder     (501) staff       (20)     1194 2023-04-04 14:19:27.000000 amuse-2023.4.0/amuse.egg-info/PKG-INFO
--rw-r--r--   0 rieder     (501) staff       (20)      372 2023-04-04 14:19:30.000000 amuse-2023.4.0/amuse.egg-info/SOURCES.txt
--rw-r--r--   0 rieder     (501) staff       (20)        1 2023-04-04 14:19:27.000000 amuse-2023.4.0/amuse.egg-info/dependency_links.txt
--rw-r--r--   0 rieder     (501) staff       (20)      760 2023-04-04 14:19:27.000000 amuse-2023.4.0/amuse.egg-info/requires.txt
--rw-r--r--   0 rieder     (501) staff       (20)        1 2023-04-04 14:19:27.000000 amuse-2023.4.0/amuse.egg-info/top_level.txt
--rw-r--r--   0 rieder     (501) staff       (20)      963 2021-07-10 08:49:37.000000 amuse-2023.4.0/pyproject.toml
--rw-r--r--   0 rieder     (501) staff       (20)       38 2023-04-04 14:19:30.092827 amuse-2023.4.0/setup.cfg
--rw-r--r--   0 rieder     (501) staff       (20)     2499 2022-10-10 09:16:43.000000 amuse-2023.4.0/setup.py
-drwxr-xr-x   0 rieder     (501) staff       (20)        0 2023-04-04 14:19:30.091882 amuse-2023.4.0/support/
--rw-r--r--   0 rieder     (501) staff       (20)      586 2020-03-24 14:36:26.000000 amuse-2023.4.0/support/__init__.py
--rw-r--r--   0 rieder     (501) staff       (20)      841 2021-07-05 11:19:28.000000 amuse-2023.4.0/support/classifiers.py
--rw-r--r--   0 rieder     (501) staff       (20)     2831 2022-11-30 13:58:15.000000 amuse-2023.4.0/support/config.py
--rw-r--r--   0 rieder     (501) staff       (20)     2167 2020-03-24 14:36:26.000000 amuse-2023.4.0/support/generate_main.py
--rw-r--r--   0 rieder     (501) staff       (20)     1356 2020-03-24 14:36:26.000000 amuse-2023.4.0/support/getsp.class
--rw-r--r--   0 rieder     (501) staff       (20)      898 2020-03-24 14:36:26.000000 amuse-2023.4.0/support/getsp.java
--rw-r--r--   0 rieder     (501) staff       (20)     1420 2020-03-24 14:36:26.000000 amuse-2023.4.0/support/misc.py
--rw-r--r--   0 rieder     (501) staff       (20)    50379 2023-04-04 13:47:06.000000 amuse-2023.4.0/support/setup_codes.py
--rw-r--r--   0 rieder     (501) staff       (20)      145 2021-04-14 10:14:49.000000 amuse-2023.4.0/support/version.py
...
### Comparing `amuse-2023.4.0/PKG-INFO` & `amuse-2023.5.0/PKG-INFO`
...
### Comparing `amuse-2023.4.0/amuse.egg-info/PKG-INFO` & `amuse-2023.5.0/amuse.egg-info/PKG-INFO`
...
### Comparing `amuse-2023.4.0/amuse.egg-info/requires.txt` & `amuse-2023.5.0/amuse.egg-info/requires.txt`
...
@@ -1,32 +1,32 @@
 matplotlib>=2.2
-amuse-framework>=2023.4.0
-amuse-athena>=2023.4.0
-amuse-bhtree>=2023.4.0
-amuse-bse>=2023.4.0
-amuse-capreole>=2023.4.0
-amuse-evtwin>=2023.4.0
-amuse-fastkick>=2023.4.0
-amuse-fi>=2023.4.0
-amuse-fractalcluster>=2023.4.0
-amuse-framework>=2023.4.0
-amuse-gadget2>=2023.4.0
-amuse-galactics>=2023.4.0
-amuse-galaxia>=2023.4.0
-amuse-halogen>=2023.4.0
-amuse-hermite>=2023.4.0
-amuse-hop>=2023.4.0
-amuse-huayno>=2023.4.0
-amuse-kepler>=2023.4.0
-amuse-kepler-orbiters>=2023.4.0
-amuse-mameclot>=2023.4.0
-amuse-mercury>=2023.4.0
-amuse-mmams>=2023.4.0
-amuse-ph4>=2023.4.0
-amuse-phigrape>=2023.4.0
-amuse-seba>=2023.4.0
-amuse-secularmultiple>=2023.4.0
-amuse-simplex>=2023.4.0
-amuse-smalln>=2023.4.0
-amuse-sphray>=2023.4.0
-amuse-sse>=2023.4.0
-amuse-twobody>=2023.4.0
...
### Comparing `amuse-2023.4.0/pyproject.toml` & `amuse-2023.5.0/pyproject.toml`
...
### Comparing `amuse-2023.4.0/setup.py` & `amuse-2023.5.0/setup.py`

 * *Files identical despite different names*

### Comparing `amuse-2023.4.0/support/__init__.py` & `amuse-2023.5.0/support/__init__.py`

 * *Files identical despite different names*

### Comparing `amuse-2023.4.0/support/classifiers.py` & `amuse-2023.5.0/support/classifiers.py`

 * *Files identical despite different names*

### Comparing `amuse-2023.4.0/support/config.py` & `amuse-2023.5.0/support/config.py`

 * *Files identical despite different names*

### Comparing `amuse-2023.4.0/support/generate_main.py` & `amuse-2023.5.0/support/generate_main.py`

 * *Files identical despite different names*

### Comparing `amuse-2023.4.0/support/getsp.class` & `amuse-2023.5.0/support/getsp.class`

 * *Files identical despite different names*

### Comparing `amuse-2023.4.0/support/getsp.java` & `amuse-2023.5.0/support/getsp.java`

 * *Files identical despite different names*

### Comparing `amuse-2023.4.0/support/misc.py` & `amuse-2023.5.0/support/misc.py`

 * *Files identical despite different names*

### Comparing `amuse-2023.4.0/support/setup_codes.py` & `amuse-2023.5.0/support/setup_codes.py`
