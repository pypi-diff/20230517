# Comparing `tmp/ufusion-1.0.7.tar.gz` & `tmp/ufusion-1.0.8.tar.gz`
...
## Comparing `ufusion-1.0.7.tar` & `ufusion-1.0.8.tar`
...
### Comparing `ufusion-1.0.7/Fusion/Fusion.py` & `ufusion-1.0.8/Fusion/Fusion.py`
...
### Comparing `ufusion-1.0.7/Fusion/Packages/packager.py` & `ufusion-1.0.8/Fusion/Packages/packager.py`

 * *Files identical despite different names*

### Comparing `ufusion-1.0.7/Fusion/download/downloader.py` & `ufusion-1.0.8/Fusion/download/downloader.py`

 * *Files identical despite different names*

### Comparing `ufusion-1.0.7/Fusion/ui/menu.py` & `ufusion-1.0.8/Fusion/ui/menu.py`
