# Comparing `tmp/cloudinary-cli-1.7.0.tar.gz` & `tmp/cloudinary-cli-1.8.0.tar.gz`
...
### Comparing `cloudinary-cli-1.7.0/cloudinary_cli/defaults.py` & `cloudinary-cli-1.8.0/cloudinary_cli/defaults.py`
