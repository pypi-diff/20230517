# Comparing `tmp/clickzetta-connector-0.6.5.tar.gz` & `tmp/clickzetta-connector-0.6.6.tar.gz`
...
### Comparing `clickzetta-connector-0.6.5/clickzetta/_helpers.py` & `clickzetta-connector-0.6.6/clickzetta/_helpers.py`
