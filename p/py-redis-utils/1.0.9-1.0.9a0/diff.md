# Comparing `tmp/py-redis-utils-1.0.9.tar.gz` & `tmp/py-redis-utils-1.0.9a0.tar.gz`
...
## Comparing `py-redis-utils-1.0.9.tar` & `py-redis-utils-1.0.9a0.tar`
...
### Comparing `py-redis-utils-1.0.9/README.md` & `py-redis-utils-1.0.9a0/README.md`

 * *Files identical despite different names*

### Comparing `py-redis-utils-1.0.9/pyredisutils/_decorators.py` & `py-redis-utils-1.0.9a0/pyredisutils/_decorators.py`
...
### Comparing `py-redis-utils-1.0.9/pyredisutils/_settings.py` & `py-redis-utils-1.0.9a0/pyredisutils/_settings.py`

 * *Files identical despite different names*

### Comparing `py-redis-utils-1.0.9/setup.py` & `py-redis-utils-1.0.9a0/setup.py`
