# Comparing `tmp/peek-platform-3.4.0.tar.gz` & `tmp/peek-platform-3.4.1.tar.gz`
...
## Comparing `peek-platform-3.4.0.tar` & `peek-platform-3.4.1.tar`
...
### Comparing `peek-platform-3.4.0/peek_platform/CeleryPatchToPlPython.py` & `peek-platform-3.4.1/peek_platform/CeleryPatchToPlPython.py`

 * *Files identical despite different names*

### Comparing `peek-platform-3.4.0/peek_platform/ConfigCeleryApp.py` & `peek-platform-3.4.1/peek_platform/ConfigCeleryApp.py`

 * *Files identical despite different names*

### Comparing `peek-platform-3.4.0/peek_platform/WindowsPatch.py` & `peek-platform-3.4.1/peek_platform/WindowsPatch.py`

 * *Files identical despite different names*

### Comparing `peek-platform-3.4.0/peek_platform/__init__.py` & `peek-platform-3.4.1/peek_platform/__init__.py`
...
### Comparing `peek-platform-3.4.0/peek_platform/file_config/PeekFileConfigABC.py` & `peek-platform-3.4.1/peek_platform/file_config/PeekFileConfigABC.py`

 * *Files identical despite different names*

### Comparing `peek-platform-3.4.0/peek_platform/file_config/PeekFileConfigDataExchangeClientMixin.py` & `peek-platform-3.4.1/peek_platform/file_config/PeekFileConfigDataExchangeClientMixin.py`

 * *Files identical despite different names*

### Comparing `peek-platform-3.4.0/peek_platform/file_config/PeekFileConfigDataExchangeServerMixin.py` & `peek-platform-3.4.1/peek_platform/file_config/PeekFileConfigDataExchangeServerMixin.py`

 * *Files identical despite different names*

### Comparing `peek-platform-3.4.0/peek_platform/file_config/PeekFileConfigDocBuildMixin.py` & `peek-platform-3.4.1/peek_platform/file_config/PeekFileConfigDocBuildMixin.py`

 * *Files identical despite different names*

### Comparing `peek-platform-3.4.0/peek_platform/file_config/PeekFileConfigFrontendDirMixin.py` & `peek-platform-3.4.1/peek_platform/file_config/PeekFileConfigFrontendDirMixin.py`

 * *Files identical despite different names*

### Comparing `peek-platform-3.4.0/peek_platform/file_config/PeekFileConfigHttpServerMixin.py` & `peek-platform-3.4.1/peek_platform/file_config/PeekFileConfigHttpServerMixin.py`

 * *Files identical despite different names*

### Comparing `peek-platform-3.4.0/peek_platform/file_config/PeekFileConfigOsMixin.py` & `peek-platform-3.4.1/peek_platform/file_config/PeekFileConfigOsMixin.py`

 * *Files identical despite different names*

### Comparing `peek-platform-3.4.0/peek_platform/file_config/PeekFileConfigPlatformMixin.py` & `peek-platform-3.4.1/peek_platform/file_config/PeekFileConfigPlatformMixin.py`

 * *Files identical despite different names*

### Comparing `peek-platform-3.4.0/peek_platform/file_config/PeekFileConfigSqlAlchemyMixin.py` & `peek-platform-3.4.1/peek_platform/file_config/PeekFileConfigSqlAlchemyMixin.py`

 * *Files identical despite different names*

### Comparing `peek-platform-3.4.0/peek_platform/file_config/PeekFileConfigTest.py` & `peek-platform-3.4.1/peek_platform/file_config/PeekFileConfigTest.py`

 * *Files identical despite different names*

### Comparing `peek-platform-3.4.0/peek_platform/file_config/PeekFileConfigWorkerMixin.py` & `peek-platform-3.4.1/peek_platform/file_config/PeekFileConfigWorkerMixin.py`

 * *Files identical despite different names*

### Comparing `peek-platform-3.4.0/peek_platform/platform_init/init_platform.py` & `peek-platform-3.4.1/peek_platform/platform_init/init_platform.py`

 * *Files identical despite different names*

### Comparing `peek-platform-3.4.0/peek_platform/plugin/PluginLoaderABC.py` & `peek-platform-3.4.1/peek_platform/plugin/PluginLoaderABC.py`

 * *Files identical despite different names*

### Comparing `peek-platform-3.4.0/peek_platform/subproc_plugin_init/plugin_subproc/plugin_subproc_child_main.py` & `peek-platform-3.4.1/peek_platform/subproc_plugin_init/plugin_subproc/plugin_subproc_child_main.py`

 * *Files identical despite different names*

### Comparing `peek-platform-3.4.0/peek_platform/subproc_plugin_init/plugin_subproc/plugin_subproc_child_state_protocol.py` & `peek-platform-3.4.1/peek_platform/subproc_plugin_init/plugin_subproc/plugin_subproc_child_state_protocol.py`

 * *Files identical despite different names*

### Comparing `peek-platform-3.4.0/peek_platform/subproc_plugin_init/plugin_subproc/plugin_subproc_child_vortex.py` & `peek-platform-3.4.1/peek_platform/subproc_plugin_init/plugin_subproc/plugin_subproc_child_vortex.py`

 * *Files identical despite different names*

### Comparing `peek-platform-3.4.0/peek_platform/subproc_plugin_init/plugin_subproc/plugin_subproc_child_vortex_protocol.py` & `peek-platform-3.4.1/peek_platform/subproc_plugin_init/plugin_subproc/plugin_subproc_child_vortex_protocol.py`

 * *Files identical despite different names*

### Comparing `peek-platform-3.4.0/peek_platform/subproc_plugin_init/plugin_subproc/plugin_subproc_child_vortex_uuid_protocol.py` & `peek-platform-3.4.1/peek_platform/subproc_plugin_init/plugin_subproc/plugin_subproc_child_vortex_uuid_protocol.py`

 * *Files identical despite different names*

### Comparing `peek-platform-3.4.0/peek_platform/subproc_plugin_init/plugin_subproc/plugin_subproc_parent_protocol.py` & `peek-platform-3.4.1/peek_platform/subproc_plugin_init/plugin_subproc/plugin_subproc_parent_protocol.py`

 * *Files identical despite different names*

### Comparing `peek-platform-3.4.0/peek_platform/subproc_plugin_init/plugin_subproc/plugin_subproc_vortex_msg_tuple.py` & `peek-platform-3.4.1/peek_platform/subproc_plugin_init/plugin_subproc/plugin_subproc_vortex_msg_tuple.py`

 * *Files identical despite different names*

### Comparing `peek-platform-3.4.0/peek_platform/subproc_plugin_init/plugin_subproc/plugin_subproc_vortex_payload_envelope_tuple.py` & `peek-platform-3.4.1/peek_platform/subproc_plugin_init/plugin_subproc/plugin_subproc_vortex_payload_envelope_tuple.py`

 * *Files identical despite different names*

### Comparing `peek-platform-3.4.0/peek_platform/subproc_plugin_init/plugin_subproc_parent_main.py` & `peek-platform-3.4.1/peek_platform/subproc_plugin_init/plugin_subproc_parent_main.py`

 * *Files identical despite different names*

### Comparing `peek-platform-3.4.0/peek_platform/subproc_plugin_init/plugin_subproc_parent_main_delegate.py` & `peek-platform-3.4.1/peek_platform/subproc_plugin_init/plugin_subproc_parent_main_delegate.py`

 * *Files identical despite different names*

### Comparing `peek-platform-3.4.0/peek_platform/sw_install/PeekSwInstallManagerABC.py` & `peek-platform-3.4.1/peek_platform/sw_install/PeekSwInstallManagerABC.py`

 * *Files identical despite different names*

### Comparing `peek-platform-3.4.0/peek_platform/sw_install/PluginSwInstallManagerABC.py` & `peek-platform-3.4.1/peek_platform/sw_install/PluginSwInstallManagerABC.py`

 * *Files identical despite different names*

### Comparing `peek-platform-3.4.0/peek_platform/sw_version/PeekSwVersionPollHandler.py` & `peek-platform-3.4.1/peek_platform/sw_version/PeekSwVersionPollHandler.py`

 * *Files identical despite different names*

### Comparing `peek-platform-3.4.0/peek_platform/util/LogUtil.py` & `peek-platform-3.4.1/peek_platform/util/LogUtil.py`

 * *Files identical despite different names*

### Comparing `peek-platform-3.4.0/peek_platform/util/ManHoleUtil.py` & `peek-platform-3.4.1/peek_platform/util/ManHoleUtil.py`

 * *Files identical despite different names*

### Comparing `peek-platform-3.4.0/peek_platform/util/MemUtil.py` & `peek-platform-3.4.1/peek_platform/util/MemUtil.py`

 * *Files identical despite different names*

### Comparing `peek-platform-3.4.0/peek_platform/util/PtyUtil.py` & `peek-platform-3.4.1/peek_platform/util/PtyUtil.py`

 * *Files identical despite different names*

### Comparing `peek-platform-3.4.0/peek_platform/winsvc_peek_restarter.py` & `peek-platform-3.4.1/peek_platform/winsvc_peek_restarter.py`

 * *Files identical despite different names*

### Comparing `peek-platform-3.4.0/peek_platform.egg-info/SOURCES.txt` & `peek-platform-3.4.1/peek_platform.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `peek-platform-3.4.0/peek_platform.egg-info/requires.txt` & `peek-platform-3.4.1/peek_platform.egg-info/requires.txt`
...
### Comparing `peek-platform-3.4.0/setup.py` & `peek-platform-3.4.1/setup.py`
