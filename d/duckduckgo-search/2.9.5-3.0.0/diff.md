# Comparing `tmp/duckduckgo_search-2.9.5.tar.gz` & `tmp/duckduckgo_search-3.0.0.tar.gz`
...
## Comparing `duckduckgo_search-2.9.5.tar` & `duckduckgo_search-3.0.0.tar`
...
### Comparing `duckduckgo_search-2.9.5/LICENSE.md` & `duckduckgo_search-3.0.0/LICENSE.md`

 * *Files identical despite different names*

### Comparing `duckduckgo_search-2.9.5/duckduckgo_search/utils.py` & `duckduckgo_search-3.0.0/tests/test_duckduckgo_search.py`
...
### Comparing `duckduckgo_search-2.9.5/pyproject.toml` & `duckduckgo_search-3.0.0/pyproject.toml`
