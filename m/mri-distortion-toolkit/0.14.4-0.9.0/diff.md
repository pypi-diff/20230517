# Comparing `tmp/mri_distortion_toolkit-0.14.4.tar.gz` & `tmp/mri_distortion_toolkit-0.9.0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "mri_distortion_toolkit-0.14.4.tar", last modified: Wed May 17 00:34:16 2023, max compression
+gzip compressed data, was "mri_distortion_toolkit-0.9.0.tar", last modified: Thu Sep  1 04:26:41 2022, max compression
```

## Comparing `mri_distortion_toolkit-0.14.4.tar` & `mri_distortion_toolkit-0.9.0.tar`

### file list

```diff
@@ -1,35 +1,26 @@
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-17 00:34:16.925435 mri_distortion_toolkit-0.14.4/
--rw-r--r--   0 runner    (1001) docker     (123)     3005 2023-05-17 00:34:16.925435 mri_distortion_toolkit-0.14.4/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)     2427 2023-05-17 00:34:05.000000 mri_distortion_toolkit-0.14.4/README.md
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-17 00:34:16.921435 mri_distortion_toolkit-0.14.4/mri_distortion_toolkit/
--rw-r--r--   0 runner    (1001) docker     (123)    33359 2023-05-17 00:34:05.000000 mri_distortion_toolkit-0.14.4/mri_distortion_toolkit/DistortionCorrection.py
--rw-r--r--   0 runner    (1001) docker     (123)     5927 2023-05-17 00:34:05.000000 mri_distortion_toolkit-0.14.4/mri_distortion_toolkit/FieldCalculation.py
--rw-r--r--   0 runner    (1001) docker     (123)    18369 2023-05-17 00:34:05.000000 mri_distortion_toolkit-0.14.4/mri_distortion_toolkit/Harmonics.py
--rw-r--r--   0 runner    (1001) docker     (123)    66249 2023-05-17 00:34:05.000000 mri_distortion_toolkit-0.14.4/mri_distortion_toolkit/MarkerAnalysis.py
--rw-r--r--   0 runner    (1001) docker     (123)    34522 2023-05-17 00:34:05.000000 mri_distortion_toolkit-0.14.4/mri_distortion_toolkit/PhantomDesigner.py
--rw-r--r--   0 runner    (1001) docker     (123)    29557 2023-05-17 00:34:05.000000 mri_distortion_toolkit-0.14.4/mri_distortion_toolkit/Reports.py
--rw-r--r--   0 runner    (1001) docker     (123)      364 2023-05-17 00:34:05.000000 mri_distortion_toolkit-0.14.4/mri_distortion_toolkit/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)     2837 2023-05-17 00:34:05.000000 mri_distortion_toolkit-0.14.4/mri_distortion_toolkit/calculate_harmonics.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-17 00:34:16.921435 mri_distortion_toolkit-0.14.4/mri_distortion_toolkit/jinja_templates/
--rw-r--r--   0 runner    (1001) docker     (123)     1927 2023-05-17 00:34:05.000000 mri_distortion_toolkit-0.14.4/mri_distortion_toolkit/jinja_templates/MR_report.html
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-17 00:34:16.921435 mri_distortion_toolkit-0.14.4/mri_distortion_toolkit/jinja_templates/themes/
--rw-r--r--   0 runner    (1001) docker     (123)      216 2023-05-17 00:34:05.000000 mri_distortion_toolkit-0.14.4/mri_distortion_toolkit/jinja_templates/themes/README.md
--rw-r--r--   0 runner    (1001) docker     (123)    11216 2023-05-17 00:34:05.000000 mri_distortion_toolkit-0.14.4/mri_distortion_toolkit/jinja_templates/themes/d42ker-github.css
--rw-r--r--   0 runner    (1001) docker     (123)     4262 2023-05-17 00:34:05.000000 mri_distortion_toolkit-0.14.4/mri_distortion_toolkit/jinja_templates/themes/whitey.css
--rw-r--r--   0 runner    (1001) docker     (123)    38542 2023-05-17 00:34:05.000000 mri_distortion_toolkit-0.14.4/mri_distortion_toolkit/utilities.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-17 00:34:16.925435 mri_distortion_toolkit-0.14.4/mri_distortion_toolkit.egg-info/
--rw-r--r--   0 runner    (1001) docker     (123)     3005 2023-05-17 00:34:16.000000 mri_distortion_toolkit-0.14.4/mri_distortion_toolkit.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)     1077 2023-05-17 00:34:16.000000 mri_distortion_toolkit-0.14.4/mri_distortion_toolkit.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-05-17 00:34:16.000000 mri_distortion_toolkit-0.14.4/mri_distortion_toolkit.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (123)       81 2023-05-17 00:34:16.000000 mri_distortion_toolkit-0.14.4/mri_distortion_toolkit.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (123)       23 2023-05-17 00:34:16.000000 mri_distortion_toolkit-0.14.4/mri_distortion_toolkit.egg-info/top_level.txt
--rw-r--r--   0 runner    (1001) docker     (123)      103 2023-05-17 00:34:05.000000 mri_distortion_toolkit-0.14.4/pyproject.toml
--rw-r--r--   0 runner    (1001) docker     (123)     1240 2023-05-17 00:34:16.925435 mri_distortion_toolkit-0.14.4/setup.cfg
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-17 00:34:16.925435 mri_distortion_toolkit-0.14.4/tests/
--rw-r--r--   0 runner    (1001) docker     (123)     2037 2023-05-17 00:34:05.000000 mri_distortion_toolkit-0.14.4/tests/test_FieldCalculation.py
--rw-r--r--   0 runner    (1001) docker     (123)     4471 2023-05-17 00:34:05.000000 mri_distortion_toolkit-0.14.4/tests/test_MarkerAnalysis.py
--rw-r--r--   0 runner    (1001) docker     (123)     2675 2023-05-17 00:34:05.000000 mri_distortion_toolkit-0.14.4/tests/test_PhantomDesigner.py
--rw-r--r--   0 runner    (1001) docker     (123)     3870 2023-05-17 00:34:06.000000 mri_distortion_toolkit-0.14.4/tests/test_distortion_correction.py
--rw-r--r--   0 runner    (1001) docker     (123)      970 2023-05-17 00:34:06.000000 mri_distortion_toolkit-0.14.4/tests/test_examples.py
--rw-r--r--   0 runner    (1001) docker     (123)     3988 2023-05-17 00:34:06.000000 mri_distortion_toolkit-0.14.4/tests/test_harmonics.py
--rw-r--r--   0 runner    (1001) docker     (123)     7956 2023-05-17 00:34:06.000000 mri_distortion_toolkit-0.14.4/tests/test_utilities.py
...
### Comparing `mri_distortion_toolkit-0.14.4/PKG-INFO` & `mri_distortion_toolkit-0.9.0/PKG-INFO`
...
### Comparing `mri_distortion_toolkit-0.14.4/README.md` & `mri_distortion_toolkit-0.9.0/README.md`
...
### Comparing `mri_distortion_toolkit-0.14.4/mri_distortion_toolkit/DistortionCorrection.py` & `mri_distortion_toolkit-0.9.0/mri_distortion_toolkit/DistortionCorrection.py`
...
### Comparing `mri_distortion_toolkit-0.14.4/mri_distortion_toolkit/FieldCalculation.py` & `mri_distortion_toolkit-0.9.0/mri_distortion_toolkit/FieldCalculation.py`
...
### Comparing `mri_distortion_toolkit-0.14.4/mri_distortion_toolkit/Harmonics.py` & `mri_distortion_toolkit-0.9.0/mri_distortion_toolkit/Harmonics.py`
...
### Comparing `mri_distortion_toolkit-0.14.4/mri_distortion_toolkit/MarkerAnalysis.py` & `mri_distortion_toolkit-0.9.0/mri_distortion_toolkit/MarkerAnalysis.py`
...
### Comparing `mri_distortion_toolkit-0.14.4/mri_distortion_toolkit/Reports.py` & `mri_distortion_toolkit-0.9.0/mri_distortion_toolkit/Reports.py`
...
### Comparing `mri_distortion_toolkit-0.14.4/mri_distortion_toolkit/calculate_harmonics.py` & `mri_distortion_toolkit-0.9.0/mri_distortion_toolkit/calculate_harmonics.py`
...
### Comparing `mri_distortion_toolkit-0.14.4/mri_distortion_toolkit/jinja_templates/MR_report.html` & `mri_distortion_toolkit-0.9.0/mri_distortion_toolkit/jinja_templates/MR_report.html`
...
### Comparing `mri_distortion_toolkit-0.14.4/mri_distortion_toolkit/jinja_templates/themes/whitey.css` & `mri_distortion_toolkit-0.9.0/mri_distortion_toolkit/jinja_templates/themes/whitey.css`
...
### Comparing `mri_distortion_toolkit-0.14.4/mri_distortion_toolkit/utilities.py` & `mri_distortion_toolkit-0.9.0/mri_distortion_toolkit/utilities.py`
...
### Comparing `mri_distortion_toolkit-0.14.4/mri_distortion_toolkit.egg-info/PKG-INFO` & `mri_distortion_toolkit-0.9.0/mri_distortion_toolkit.egg-info/PKG-INFO`
...
### Comparing `mri_distortion_toolkit-0.14.4/setup.cfg` & `mri_distortion_toolkit-0.9.0/setup.cfg`
...
-000003c0: 740a 0a5b 6f70 7469 6f6e 732e 7061 636b  t..[options.pack
-000003d0: 6167 655f 6461 7461 5d0a 2a20 3d20 2a2e  age_data].* = *.
-000003e0: 6874 6d6c 2c20 2a2e 6d64 2c20 2a2e 6373  html, *.md, *.cs
-000003f0: 730a 6d72 695f 6469 7374 6f72 7469 6f6e  s.mri_distortion
-00000400: 5f74 6f6f 6c6b 6974 2e6a 696e 6a61 5f74  _toolkit.jinja_t
-00000410: 656d 706c 6174 6573 203d 202a 2e68 746d  emplates = *.htm
-00000420: 6c0a 6d72 695f 6469 7374 6f72 7469 6f6e  l.mri_distortion
-00000430: 5f74 6f6f 6c6b 6974 2e6a 696e 6a61 5f74  _toolkit.jinja_t
-00000440: 656d 706c 6174 6573 2e74 6865 6d65 7320  emplates.themes 
-00000450: 3d20 2a2e 6373 732c 202a 2e6d 640a 0a5b  = *.css, *.md..[
-00000460: 746f 6f6c 3a69 6e74 6572 726f 6761 7465  tool:interrogate
-00000470: 5d0a 6967 6e6f 7265 2d69 6e69 742d 6d65  ].ignore-init-me
-00000480: 7468 6f64 203d 2074 7275 650a 6967 6e6f  thod = true.igno
-00000490: 7265 2d6d 6f64 756c 6520 3d20 7472 7565  re-module = true
-000004a0: 0a66 6169 6c2d 756e 6465 7220 3d20 3935  .fail-under = 95
-000004b0: 0a0a 5b65 6767 5f69 6e66 6f5d 0a74 6167  ..[egg_info].tag
-000004c0: 5f62 7569 6c64 203d 200a 7461 675f 6461  _build = .tag_da
-000004d0: 7465 203d 2030 0a0a                      te = 0..
