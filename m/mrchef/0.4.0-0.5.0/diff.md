# Comparing `tmp/mrchef-0.4.0.tar.gz` & `tmp/mrchef-0.5.0.tar.gz`
...
## Comparing `mrchef-0.4.0.tar` & `mrchef-0.5.0.tar`
...
### Comparing `mrchef-0.4.0/LICENSE` & `mrchef-0.5.0/LICENSE`

 * *Files identical despite different names*

### Comparing `mrchef-0.4.0/README.md` & `mrchef-0.5.0/README.md`

 * *Files identical despite different names*

### Comparing `mrchef-0.4.0/mrchef/cli.py` & `mrchef-0.5.0/mrchef/cli.py`

 * *Files identical despite different names*

### Comparing `mrchef-0.4.0/mrchef/lib.py` & `mrchef-0.5.0/mrchef/lib.py`
...
### Comparing `mrchef-0.4.0/pyproject.toml` & `mrchef-0.5.0/pyproject.toml`
...
### Comparing `mrchef-0.4.0/setup.py` & `mrchef-0.5.0/setup.py`
...
### Comparing `mrchef-0.4.0/PKG-INFO` & `mrchef-0.5.0/PKG-INFO`
