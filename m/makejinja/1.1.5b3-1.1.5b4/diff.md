# Comparing `tmp/makejinja-1.1.5b3.tar.gz` & `tmp/makejinja-1.1.5b4.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "makejinja-1.1.5b3.tar", max compression
+gzip compressed data, was "makejinja-1.1.5b4.tar", max compression
```

## Comparing `makejinja-1.1.5b3.tar` & `makejinja-1.1.5b4.tar`

### file list

```diff
@@ -1,12 +1,12 @@
--rw-r--r--   0        0        0     1067 2023-05-09 09:26:59.615276 makejinja-1.1.5b3/LICENSE
--rw-r--r--   0        0        0    16983 2023-05-09 09:26:59.615276 makejinja-1.1.5b3/README.md
--rw-r--r--   0        0        0      101 2023-05-09 09:26:59.615276 makejinja-1.1.5b3/makejinja/__init__.py
--rw-r--r--   0        0        0       48 2023-05-09 09:26:59.615276 makejinja-1.1.5b3/makejinja/__main__.py
--rw-r--r--   0        0        0     5805 2023-05-09 09:26:59.615276 makejinja-1.1.5b3/makejinja/app.py
--rw-r--r--   0        0        0     1291 2023-05-09 09:26:59.615276 makejinja-1.1.5b3/makejinja/cli.py
--rw-r--r--   0        0        0    12184 2023-05-09 09:26:59.615276 makejinja-1.1.5b3/makejinja/config.py
--rw-r--r--   0        0        0     1060 2023-05-09 09:26:59.615276 makejinja-1.1.5b3/makejinja/loader.py
--rw-r--r--   0        0        0        0 2023-05-09 09:26:59.615276 makejinja-1.1.5b3/makejinja/py.typed
--rw-r--r--   0        0        0      813 2023-05-09 09:28:26.903710 makejinja-1.1.5b3/pyproject.toml
--rw-r--r--   0        0        0    18208 1970-01-01 00:00:00.000000 makejinja-1.1.5b3/setup.py
--rw-r--r--   0        0        0    17845 1970-01-01 00:00:00.000000 makejinja-1.1.5b3/PKG-INFO
...
### Comparing `makejinja-1.1.5b3/LICENSE` & `makejinja-1.1.5b4/LICENSE`

 * *Files identical despite different names*

### Comparing `makejinja-1.1.5b3/README.md` & `makejinja-1.1.5b4/README.md`
...
### Comparing `makejinja-1.1.5b3/makejinja/app.py` & `makejinja-1.1.5b4/makejinja/app.py`

 * *Files identical despite different names*

### Comparing `makejinja-1.1.5b3/makejinja/cli.py` & `makejinja-1.1.5b4/makejinja/cli.py`

 * *Files identical despite different names*

### Comparing `makejinja-1.1.5b3/makejinja/config.py` & `makejinja-1.1.5b4/makejinja/config.py`

 * *Files identical despite different names*

### Comparing `makejinja-1.1.5b3/makejinja/loader.py` & `makejinja-1.1.5b4/makejinja/loader.py`

 * *Files identical despite different names*

### Comparing `makejinja-1.1.5b3/pyproject.toml` & `makejinja-1.1.5b4/pyproject.toml`
...
### Comparing `makejinja-1.1.5b3/setup.py` & `makejinja-1.1.5b4/setup.py`
...
### Comparing `makejinja-1.1.5b3/PKG-INFO` & `makejinja-1.1.5b4/PKG-INFO`
