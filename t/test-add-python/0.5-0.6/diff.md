# Comparing `tmp/test_add_python-0.5.tar.gz` & `tmp/test_add_python-0.6.tar.gz`
...
## Comparing `test_add_python-0.5.tar` & `test_add_python-0.6.tar`
...
### Comparing `test_add_python-0.5/PKG-INFO` & `test_add_python-0.6/PKG-INFO`
...
### Comparing `test_add_python-0.5/README.md` & `test_add_python-0.6/README.md`

 * *Files identical despite different names*

### Comparing `test_add_python-0.5/setup.py` & `test_add_python-0.6/setup.py`
...
### Comparing `test_add_python-0.5/src/test_add.cu` & `test_add_python-0.6/src/test_add.cu`

 * *Files identical despite different names*

### Comparing `test_add_python-0.5/src/test_add_cpu.cpp` & `test_add_python-0.6/src/test_add_cpu.cpp`

 * *Files identical despite different names*

### Comparing `test_add_python-0.5/test_add_python.egg-info/PKG-INFO` & `test_add_python-0.6/test_add_python.egg-info/PKG-INFO`
...
### Comparing `test_add_python-0.5/test_add_wrapper.pyx` & `test_add_python-0.6/test_add_wrapper.pyx`
