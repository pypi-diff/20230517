# Comparing `tmp/swibots-1.1.7.tar.gz` & `tmp/swibots-1.1.8.tar.gz`
...
### Comparing `swibots-1.1.7/swibots/api/bot/models/bot_command_info.py` & `swibots-1.1.8/swibots/api/bot/models/bot_command_info.py`
...
### Comparing `swibots-1.1.7/swibots/bots/decorators/on_community_updated.py` & `swibots-1.1.8/swibots/bots/decorators/on_community_updated.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.7/swibots/bots/decorators/on_group_created.py` & `swibots-1.1.8/swibots/bots/decorators/on_group_created.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.7/swibots/bots/decorators/on_group_deleted.py` & `swibots-1.1.8/swibots/bots/decorators/on_group_deleted.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.7/swibots/bots/decorators/on_group_updated.py` & `swibots-1.1.8/swibots/bots/decorators/on_group_updated.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.7/swibots/bots/decorators/on_inline_query.py` & `swibots-1.1.8/swibots/bots/decorators/on_inline_query.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.7/swibots/bots/decorators/on_member_joined.py` & `swibots-1.1.8/swibots/bots/decorators/on_member_joined.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.7/swibots/bots/decorators/on_member_left.py` & `swibots-1.1.8/swibots/bots/decorators/on_member_left.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.7/swibots/bots/decorators/on_unknown_command.py` & `swibots-1.1.8/swibots/bots/decorators/on_unknown_command.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.7/swibots/bots/filters/filter.py` & `swibots-1.1.8/swibots/bots/filters/filter.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.7/swibots/bots/handlers/__init__.py` & `swibots-1.1.8/swibots/bots/handlers/__init__.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.7/swibots/bots/handlers/base_handler.py` & `swibots-1.1.8/swibots/bots/handlers/base_handler.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.7/swibots/bots/handlers/callback_query_handler.py` & `swibots-1.1.8/swibots/bots/handlers/callback_query_handler.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.7/swibots/bots/handlers/channel_created_handler.py` & `swibots-1.1.8/swibots/bots/handlers/channel_created_handler.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.7/swibots/bots/handlers/channel_deleted_handler.py` & `swibots-1.1.8/swibots/bots/handlers/channel_deleted_handler.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.7/swibots/bots/handlers/channel_updated_handler.py` & `swibots-1.1.8/swibots/bots/handlers/channel_updated_handler.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.7/swibots/bots/handlers/command_handler.py` & `swibots-1.1.8/swibots/bots/handlers/command_handler.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.7/swibots/bots/handlers/community_updated_handler.py` & `swibots-1.1.8/swibots/bots/handlers/community_updated_handler.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.7/swibots/bots/handlers/event_handler.py` & `swibots-1.1.8/swibots/bots/handlers/event_handler.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.7/swibots/bots/handlers/group_created_handler.py` & `swibots-1.1.8/swibots/bots/handlers/group_created_handler.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.7/swibots/bots/handlers/group_deleted_handler.py` & `swibots-1.1.8/swibots/bots/handlers/group_deleted_handler.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.7/swibots/bots/handlers/group_updated_handler.py` & `swibots-1.1.8/swibots/bots/handlers/group_updated_handler.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.7/swibots/bots/handlers/inline_query_handler.py` & `swibots-1.1.8/swibots/bots/handlers/inline_query_handler.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.7/swibots/bots/handlers/member_joined_handler.py` & `swibots-1.1.8/swibots/bots/handlers/member_joined_handler.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.7/swibots/bots/handlers/member_left_handler.py` & `swibots-1.1.8/swibots/bots/handlers/member_left_handler.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.7/swibots/bots/handlers/message_handler.py` & `swibots-1.1.8/swibots/bots/handlers/message_handler.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.7/swibots/bots/handlers/unknown_command_handler.py` & `swibots-1.1.8/swibots/bots/handlers/unknown_command_handler.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.7/swibots/bots/handlers/user_banned_handler.py` & `swibots-1.1.8/swibots/bots/handlers/user_banned_handler.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.7/swibots/config.py` & `swibots-1.1.8/swibots/config.py`
...
-        or "ws://api-gateway.switch.pe/v1/websocket/community/ws",
...
-        "COMMUNITY_SERVICE_WS_URL") or "ws://api-gateway.switch.pe/v1/websocket/community/ws"
...
### Comparing `swibots-1.1.7/swibots/error.py` & `swibots-1.1.8/swibots/error.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.7/swibots/types.py` & `swibots-1.1.8/swibots/types.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.7/swibots/utils/rest_client.py` & `swibots-1.1.8/swibots/utils/rest_client.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.7/swibots/utils/types.py` & `swibots-1.1.8/swibots/utils/types.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.7/swibots/utils/ws/asyncstomp/async_ws_client.py` & `swibots-1.1.8/swibots/utils/ws/asyncstomp/async_ws_client.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.7/swibots/utils/ws/asyncstomp/async_ws_subscription.py` & `swibots-1.1.8/swibots/utils/ws/asyncstomp/async_ws_subscription.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.7/swibots/utils/ws/common/ws_frame.py` & `swibots-1.1.8/swibots/utils/ws/common/ws_frame.py`

 * *Files identical despite different names*

### Comparing `swibots-1.1.7/swibots.egg-info/PKG-INFO` & `swibots-1.1.8/swibots.egg-info/PKG-INFO`
...
### Comparing `swibots-1.1.7/swibots.egg-info/SOURCES.txt` & `swibots-1.1.8/swibots.egg-info/SOURCES.txt`
