# Comparing `tmp/spotON_sdk-0.0.4.3.tar.gz` & `tmp/spotON_sdk-0.0.4.4.tar.gz`
...
## Comparing `spotON_sdk-0.0.4.3.tar` & `spotON_sdk-0.0.4.4.tar`
...
### Comparing `spotON_sdk-0.0.4.3/.gitignore` & `spotON_sdk-0.0.4.4/.gitignore`

 * *Files identical despite different names*

### Comparing `spotON_sdk-0.0.4.3/LICENSE` & `spotON_sdk-0.0.4.4/LICENSE`

 * *Files identical despite different names*

### Comparing `spotON_sdk-0.0.4.3/spotON_sdk/data_helpers/BestHour.py` & `spotON_sdk-0.0.4.4/spotON_sdk/data_helpers/BestHour.py`

 * *Files identical despite different names*

### Comparing `spotON_sdk-0.0.4.3/spotON_sdk/data_helpers/dataframe_modifier.py` & `spotON_sdk-0.0.4.4/spotON_sdk/data_helpers/dataframe_modifier.py`

 * *Files identical despite different names*

### Comparing `spotON_sdk-0.0.4.3/spotON_sdk/data_helpers/entsoe_query.py` & `spotON_sdk-0.0.4.4/spotON_sdk/data_helpers/entsoe_query.py`

 * *Files identical despite different names*

### Comparing `spotON_sdk-0.0.4.3/spotON_sdk/settings/Config/Config.py` & `spotON_sdk-0.0.4.4/spotON_sdk/settings/Config/Config.py`

 * *Files identical despite different names*

### Comparing `spotON_sdk-0.0.4.3/spotON_sdk/settings/Config/bidding_zones.py` & `spotON_sdk-0.0.4.4/spotON_sdk/settings/Config/bidding_zones.py`

 * *Files identical despite different names*

### Comparing `spotON_sdk-0.0.4.3/spotON_sdk/settings/Config/countries.py` & `spotON_sdk-0.0.4.4/spotON_sdk/settings/Config/countries.py`

 * *Files identical despite different names*

### Comparing `spotON_sdk-0.0.4.3/spotON_sdk/settings/Config/markets.py` & `spotON_sdk-0.0.4.4/spotON_sdk/settings/Config/markets.py`
